    ...
    <head>
        ...
        <link href="login/vendor/bootstrap/css/additional.css" rel="stylesheet">

        <!-- MetisMenu CSS -->
        <link href="login/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

        <!-- DataTables CSS -->
        <link href="login/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

        <!-- DataTables Responsive CSS -->
        <link href="login/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
 ...
 <div class="row">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse">
                                        <div class="panel-body"><form name = "create" method = "POST" action = "newMenu.php">
                                                            ...
                                                            <tr>
                                                                <td>Product ID</td>
                                                                <td><select id = "deleteID" name = "deleteID" >
                                    ...
                                    <style>
                                        ...
                                        tr, td{
                                            padding: 10px;
                                                        ...
                                                        <input type = "submit" name = "submitDelete" id = "submitDelete" value = "Delete from menu">
                                                        </form>
                                        </div>
                                    </div>
                                </div>
        ...
        <script src="login/vendor/datatables/js/jquery.dataTables.min.js"></script>
        <script src="login/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
        <script src="login/vendor/datatables-responsive/dataTables.responsive.js"></script>
