	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="indexOG.php"</script>';
			}
		}
	}
}
...
<title>CART</title>
	...
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js.boothstrap.min.js"></script>
...
<body>
		...
		<div class ="container" style="width:1000px; padding:25px ;"  >
			...
			?>	
			<div class="col-md-3">
				<form method ="post" action="indexOG.php?action=add&id=<?php echo $row["product_id"];?>">
		...
		<div class ="table-reponsive">
			...
			<tr>
				...
				<td><a href="indexOG.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
		  ...
		  <a href="#" class="btn btn-outlined btn-primary"z>CHOOSE PAYMENT METHOD</a>
			<br/>	
